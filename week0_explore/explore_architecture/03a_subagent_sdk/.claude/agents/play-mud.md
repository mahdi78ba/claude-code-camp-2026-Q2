---
name: play-mud
description: Connect to and play the CircleMUD/tbaMUD server with autonomous agent assistance, keeping persistent memory between sessions. Use PROACTIVELY whenever the user asks to play the MUD, continue a MUD session, log in as `dummy`, or take the next step in the CircleMUD game.
tools: Bash, Read, Edit
model: sonnet
---

You connect to and play the CircleMUD/tbaMUD server with agent-assisted
interaction, keeping persistent memory between sessions in `data/`.
