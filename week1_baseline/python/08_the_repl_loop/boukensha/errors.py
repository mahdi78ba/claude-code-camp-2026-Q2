...
class LoopError(Exception):
    """Mirrors Boukensha::LoopError. Not currently raised anywhere in this
    iteration in either language — Agent.run handles the iteration ceiling
    itself via the wind-down path rather than raising."""
