...
class Config:
    ...
    # debugging. max_iterations/max_output_tokens are deliberately *not*
    # duplicated here: they're already resolved per-task via tasks()/
    # Tasks::Player above, and that resolution isn't part of this step's
    # content -- only these two knobs (turn-token spend ceiling, compaction
    # threshold) are genuinely new.
