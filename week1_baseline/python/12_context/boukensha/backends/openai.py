"""Serializes a Context into the OpenAI Chat Completions API format.

Python port of Boukensha::Backends::OpenAI.
"""
...
class OpenAI(Base):
    ...
    def parse_response(self, response):
        """Normalizes an OpenAI chat completions response into the common
        shape: {stop_reason: "tool_use" | "end_turn",
    ...
    def _assistant_message(self, content):
        """Rebuilds an OpenAI assistant message from normalized content
